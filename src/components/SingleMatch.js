    ...
    return (
            <div className="single_match">
                ...
                <div className="horizontal_items">
                    ...
                    <Link to={{ pathname: `/teamDetails/${props.matchData.hTeam.teamId}`,
                    ...
                    <div className="match_score bold">{props.matchData.hTeam.score.points ? props.matchData.hTeam.score.points : "."}</div>
                    <div className="separator"></div>
                    <div className="match_score bold">{props.matchData.vTeam.score.points ? props.matchData.vTeam.score.points : "."}</div>

                    <div className="visitor_team">
                        <Link to={{ pathname: `/teamDetails/${props.matchData.vTeam.teamId}`,
                ...
                {showingDetails ?
                    <GameDetails ID={props.matchData.gameId} backFromDetails={backFromDetails} />
                    :
                    <div className="btn" onClick={handleDetailsClick}>GAME DETAILS</div>
                }
            </div>
    );
}
